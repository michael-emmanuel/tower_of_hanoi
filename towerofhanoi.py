"""THE TOWER OF HANOI, A Stack moving puzzle game."""
...
def main():
    ...
    """The towers dictionar has keys "A", "B", and "C" and values 
  that are lists representing a tower of disks. The list contains 
  inegers representin disks of different sizes, and the start of
  ...
  configuration. The list [3, 1] is allowed since smaller disk
